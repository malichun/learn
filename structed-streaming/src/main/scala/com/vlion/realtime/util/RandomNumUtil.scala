package com.vlion.realtime.util
...
object RandomNumUtil {
    ...
    def randomInt(from: Int, to: Int): Int = {
        if(from > to) throw new IllegalArgumentException(s"from = $from 应小于 to= $to")
    ...
    def main(args: Array[String]): Unit = {
        ...
        println(randomMultiInt(1, 80, 10, false))
    }
